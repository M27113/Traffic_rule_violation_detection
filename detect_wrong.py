    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for (objectID, centroid) in objects.items():
            ...
            if (cy2<=cy1):                  #check whether the vehicle is incoming or outgoing
                ...
                #cv2.putText(im0, text, (centroid[0] - 10, centroid[1] - 10),cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0,255, 0), 2)
                #cv2.circle(im0, (centroid[0], centroid[1]), 3, (0, 0, 255), -1)
            else:
                #text = "{}".format('WRONG DIRECTION')
                #text = "ID: {}".format(objectID)
                #cv2.putText(im0, text, (centroid[0] - 10, centroid[1] - 10),cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0,0, 255), 2)
                cv2.circle(im0, (centroid[0], centroid[1]), 3, (0, 0, 255), -1)
